...
US-074/US-075 documentation SHALL cross-link weekly gap policy and operator-settings intent (US-082) and SHALL NOT require implementing runtime sensor, settings store, discovery, or approve endpoints as part of satisfying these requirements.

#### Scenario: Docs-only scope preserved

- **WHEN** this capability’s change tasks are completed
- **THEN** normative docs and glossary/editorial alignment exist
- **AND** no new worker HTTP routes or n8n Execute Command usage are introduced by this capability
