...
Durable Postgres-backed hand-curated editorial content backlog (US-049 / BL-020 Story 1): authenticated HTTP create/list/update for topic, audience, objective, format, priority, status, target date, and LinkedIn derivative planning notes. Optional enrichment only — MUST NOT gate Flow B discovery, draft generation, or gap trigger. US-050 dependency UX and discovery seeding remain out of scope.
