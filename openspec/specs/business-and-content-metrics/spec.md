...
Operator-visible normative definition of **BL-022** business and content metric families for **US-053** (blog traffic; LinkedIn reach and engagement; profile visits and audience growth) and **US-054** (recruiter/executive conversations; job/consulting opportunities; high-performing topics and formats). Includes plain-language definitions, intended sources, review cadence, supporting reuse of existing publication evidence, and clear blocked/unavailable vocabulary — without requiring an analytics platform, auto-collection worker, Flow A/B gating, BL-023 collection/feedback loops, or changes to `SILVERMAN_LINKEDIN_PUBLICATION_ENABLED`.
