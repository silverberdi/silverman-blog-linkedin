...
**Reason:** US-050 implements dependency identification and prioritization / reprioritization. Discovery seeding remains excluded under the new US-050 scope requirement above; the US-049-only exclusion that forbade dependency UX is obsolete.

**Migration:** Implement dependency and prioritization requirements in this change. Keep discovery seed/override, packaging, and auto-publish out of scope. Do not treat archived US-049 change text as active requirements.
