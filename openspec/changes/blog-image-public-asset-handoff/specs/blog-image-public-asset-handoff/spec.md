# blog-image-public-asset-handoff

## Purpose

Production-safe handoff of blog hero images from the editorial workspace (or ComfyUI generation) into the configured public GitHub Pages repository `assets/images/` path. Ensures Jekyll-canonical public assets exist before Flow A validation and publish continue, without manual operator copying.
