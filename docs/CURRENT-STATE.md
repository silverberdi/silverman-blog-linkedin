...
- LinkedIn variant review policy (**US-015** / BL-006 story 1): **policy defined** — operator-facing Flow A strategy-driven publication default, optional `pending` supervision window, Flow A vs Flow B mandatory review distinction, blocked/deferred states. Docs/spec only; US-016/US-017 enforcement and supervision console remain open. Evidence: [linkedin-variant-review-policy.md](operations/linkedin-variant-review-policy.md). BL-006 backlog item remains open until US-016 and US-017.
...
- **BL-006** US-016/US-017 — quality/differentiation criteria and correction/rejection-before-queue mechanics (US-015 policy defined; see [linkedin-variant-review-policy.md](operations/linkedin-variant-review-policy.md))
