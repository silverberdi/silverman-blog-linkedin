...
| **Editorial restoration / recovery procedure (US-037)** | Testing restoration and documenting the recovery procedure that can restore calendar, campaigns, runs, posts, images, and LinkedIn artifacts from a verified backup. Distinct from US-036 scope/retention/integrity definition; not claimed complete by US-036 alone |
