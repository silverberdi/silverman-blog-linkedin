...
| **Business and content metrics (US-053)** | Operator-facing outcome metrics for the content program: blog traffic; LinkedIn reach and engagement (eligible only for **Live on LinkedIn** or an explicitly documented manual-post exception); profile visits and audience growth. Normative definition: [business-and-content-metrics.md](operations/business-and-content-metrics.md). Manual-first tracking + durable log template satisfy “track” for Story 1; automated collection is **BL-023**. MUST NOT mean Authority Manager triage counts, `flow_a_complete`, blog handoff, or `distribution_scheduled` as measured reach |
| **Operational metric chips** | Authority Manager at-a-glance publication-triage counts (e.g. upcoming, pending, due soon, deferred, blocked, failed, recently published). Answer “what needs attention in the console,” not US-053 business/content outcomes. Distinct from **business and content metrics** |
