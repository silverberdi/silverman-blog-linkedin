...
| **Business and content metrics (US-053 / US-054)** | Operator-facing metrics for the content program. **US-053:** blog traffic; LinkedIn reach and engagement (eligible only for **Live on LinkedIn** or an explicitly documented manual-post exception); profile visits and audience growth. **US-054:** recruiter/executive conversations (two-way professional exchange — not one-way likes/reactions); job/consulting opportunities (concrete prospects); high-performing topics/formats (thin operator criteria using US-053 signals where available + optional outcome attribution — not a BI rank from schedule/pending/package-complete). Normative definition: [business-and-content-metrics.md](operations/business-and-content-metrics.md). Manual-first tracking + durable log template satisfy “track” for Stories 1–2; automated collection is **BL-023**. MUST NOT mean Authority Manager triage counts, `flow_a_complete`, blog handoff, or `distribution_scheduled` as measured reach or outcomes |
| **Operational metric chips** | Authority Manager at-a-glance publication-triage counts (e.g. upcoming, pending, due soon, deferred, blocked, failed, recently published). Answer “what needs attention in the console,” not US-053/US-054 business/content outcomes. Distinct from **business and content metrics** |
