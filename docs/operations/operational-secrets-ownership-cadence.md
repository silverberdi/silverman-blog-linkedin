...
| LinkedIn token store | `SILVERMAN_LINKEDIN_TOKEN_STORE_PATH` / `secrets/linkedin-oauth/*` | System owner | On refresh failure / reauthorization required | Lifecycle detail: BL-025 + LinkedIn prerequisites docs. |
